...
const articleUrl = 'https://mizore.blog/zh/xiaomi-book-pro-14/?view=full'
...
describe('same-document article fragments', () => {
  ...
  it.each([
    'https://example.com/zh/xiaomi-book-pro-14/?view=full#heading',
    'https://mizore.blog/zh/another-post/?view=full#heading',
    'https://mizore.blog/zh/xiaomi-book-pro-14/?view=summary#heading',
    'https://mizore.blog/zh/xiaomi-book-pro-14/?view=full',
