  ...
  return (
    <div className="group relative">
      <button
        ...
        aria-live="polite"
        onClick={onCopy}
        className="dark:bg-surface-raised-dark/85 absolute top-2 right-2 z-10 rounded-[6px] border border-slate-300/70 bg-white/85 px-2 py-1 text-xs text-slate-600 opacity-100 shadow-sm backdrop-blur transition-colors duration-200 hover:text-sky-700 focus:opacity-100 dark:border-white/15 dark:text-white/70 dark:hover:text-sky-300 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100"
      >
